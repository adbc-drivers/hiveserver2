...
// LOCAL EDIT (test fixture only): declare a private C#/netstd namespace so the
// freshly-generated classes can coexist with the driver's hand-edited copies
// under Apache.Hive.Service.Rpc.Thrift. Nothing else in this file has been
// modified from upstream apache/hive master.
namespace netstd Apache.Hive.Service.Rpc.Thrift.Reference
