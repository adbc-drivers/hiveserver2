...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationState _operationState;
    ...
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TProgressUpdateResp _progressUpdateResponse;
    ...
    /// <summary>
    /// 
    /// <seealso cref="global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationState"/>
    /// </summary>
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationState OperationState
    {
      get
      {
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TProgressUpdateResp ProgressUpdateResponse
    {
      get
      {
    ...
    public TGetOperationStatusResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TGetOperationStatusResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp445.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      ...
      {
        tmp445.ProgressUpdateResponse = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TProgressUpdateResp)this.ProgressUpdateResponse.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                OperationState = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationState)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
            ...
            case 10:
              if (field.Type == TType.Struct)
              {
                ProgressUpdateResponse = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TProgressUpdateResp();
