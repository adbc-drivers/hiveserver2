...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TSetClientInfoResp : TBase
  {
    ...
    public TSetClientInfoResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TSetClientInfoResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp276.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      return tmp276;
    }
