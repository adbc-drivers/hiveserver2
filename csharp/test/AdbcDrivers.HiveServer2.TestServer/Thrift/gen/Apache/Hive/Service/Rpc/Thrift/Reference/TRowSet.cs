...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private List<global::Apache.Hive.Service.Rpc.Thrift.Reference.TColumn> _columns;
    private byte[] _binaryColumns;
    private int _columnCount;

    public long StartRowOffset { get; set; }

    public List<global::Apache.Hive.Service.Rpc.Thrift.Reference.TRow> Rows { get; set; }

    public List<global::Apache.Hive.Service.Rpc.Thrift.Reference.TColumn> Columns
    {
      get
      {
        return _columns;
    ...
    public TRowSet(long startRowOffset, List<global::Apache.Hive.Service.Rpc.Thrift.Reference.TRow> @rows) : this()
    {
              ...
              {
                {
                  ...
                  Rows = new List<global::Apache.Hive.Service.Rpc.Thrift.Reference.TRow>(_list210.Count);
                  for(int _i211 = 0; _i211 < _list210.Count; ++_i211)
                  {
                    global::Apache.Hive.Service.Rpc.Thrift.Reference.TRow _elem212;
                    _elem212 = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TRow();
              ...
              {
                {
                  ...
                  Columns = new List<global::Apache.Hive.Service.Rpc.Thrift.Reference.TColumn>(_list213.Count);
                  for(int _i214 = 0; _i214 < _list213.Count; ++_i214)
                  {
                    global::Apache.Hive.Service.Rpc.Thrift.Reference.TColumn _elem215;
                    _elem215 = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TColumn();
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((Rows != null))
        {
          ...
          foreach (global::Apache.Hive.Service.Rpc.Thrift.Reference.TRow _iter218 in Rows)
          {
        ...
        if((Columns != null) && __isset.@columns)
        {
          ...
          foreach (global::Apache.Hive.Service.Rpc.Thrift.Reference.TColumn _iter219 in Columns)
          {
    ...
    {
      var tmp220 = new StringBuilder("TRowSet(");
      tmp220.Append(", StartRowOffset: ");
      StartRowOffset.ToString(tmp220);
      if((Rows != null))
      {
        tmp220.Append(", Rows: ");
        Rows.ToString(tmp220);
      }
      if((Columns != null) && __isset.@columns)
      {
        tmp220.Append(", Columns: ");
        Columns.ToString(tmp220);
      }
      if((BinaryColumns != null) && __isset.binaryColumns)
      {
        tmp220.Append(", BinaryColumns: ");
        BinaryColumns.ToString(tmp220);
      }
      if(__isset.columnCount)
      {
        tmp220.Append(", ColumnCount: ");
        ColumnCount.ToString(tmp220);
      }
      tmp220.Append(')');
