...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TBinaryColumn : TBase
  {
    ...
    {
      var tmp195 = new TBinaryColumn();
      if((Values != null))
      {
        tmp195.Values = this.Values.DeepCopy();
      }
      if((Nulls != null))
      {
        tmp195.Nulls = this.Nulls.ToArray();
      }
      return tmp195;
    }
              ...
              {
                {
                  ...
                  Values = new List<byte[]>(_list196.Count);
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((Values != null))
        {
          ...
          foreach (byte[] _iter201 in Values)
          {
