...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TDownloadDataResp : TBase
  {
    ...
    public TDownloadDataResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status, global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle operationHandle) : this()
    {
      this.Status = @status;
    ...
    public TDownloadDataResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp351.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null))
      {
        tmp351.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      return tmp351;
    }
