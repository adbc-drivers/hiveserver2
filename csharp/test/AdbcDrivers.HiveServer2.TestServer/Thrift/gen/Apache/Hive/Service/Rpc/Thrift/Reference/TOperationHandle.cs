...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TOperationHandle : TBase
  {
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier OperationId { get; set; }

    /// <summary>
    /// 
    /// <seealso cref="global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationType"/>
    /// </summary>
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationType OperationType { get; set; }
    ...
    public TOperationHandle(global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier operationId, global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationType operationType, bool hasResultSet) : this()
    {
    ...
    public TOperationHandle DeepCopy()
    {
      ...
      if((OperationId != null))
      {
        tmp241.OperationId = (global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier)this.OperationId.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                OperationId = new global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier();
            ...
            case 2:
              ...
              {
                OperationType = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationType)await iprot.ReadI32Async(cancellationToken);
    ...
    {
      var tmp244 = new StringBuilder("TOperationHandle(");
      if((OperationId != null))
      {
        tmp244.Append(", OperationId: ");
        OperationId.ToString(tmp244);
      }
      tmp244.Append(", OperationType: ");
      OperationType.ToString(tmp244);
      tmp244.Append(", HasResultSet: ");
      HasResultSet.ToString(tmp244);
      if(__isset.modifiedRowCount)
      {
        tmp244.Append(", ModifiedRowCount: ");
        ModifiedRowCount.ToString(tmp244);
      }
      tmp244.Append(')');
