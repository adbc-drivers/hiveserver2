...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetInfoValue : TBase
  {
    ...
    {
      var tmp291 = new TGetInfoValue();
      if((StringValue != null) && __isset.stringValue)
      {
        tmp291.StringValue = this.StringValue;
      }
      tmp291.__isset.stringValue = this.__isset.stringValue;
      if(__isset.smallIntValue)
      {
        tmp291.SmallIntValue = this.SmallIntValue;
      }
      tmp291.__isset.smallIntValue = this.__isset.smallIntValue;
      if(__isset.integerBitmask)
      {
        tmp291.IntegerBitmask = this.IntegerBitmask;
      }
      tmp291.__isset.integerBitmask = this.__isset.integerBitmask;
      if(__isset.integerFlag)
      {
        tmp291.IntegerFlag = this.IntegerFlag;
      }
      tmp291.__isset.integerFlag = this.__isset.integerFlag;
      if(__isset.binaryValue)
      {
        tmp291.BinaryValue = this.BinaryValue;
      }
      tmp291.__isset.binaryValue = this.__isset.binaryValue;
      if(__isset.lenValue)
      {
        tmp291.LenValue = this.LenValue;
      }
      tmp291.__isset.lenValue = this.__isset.lenValue;
      return tmp291;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp292 = new TStruct("TGetInfoValue");
        await oprot.WriteStructBeginAsync(tmp292, cancellationToken);
        var tmp293 = new TField();
        if((StringValue != null) && __isset.stringValue)
        {
          tmp293.Name = "stringValue";
          tmp293.Type = TType.String;
          tmp293.ID = 1;
        ...
        if(__isset.smallIntValue)
        {
          tmp293.Name = "smallIntValue";
          tmp293.Type = TType.I16;
          tmp293.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp293, cancellationToken);
        ...
        if(__isset.integerBitmask)
        {
          tmp293.Name = "integerBitmask";
          tmp293.Type = TType.I32;
          tmp293.ID = 3;
          await oprot.WriteFieldBeginAsync(tmp293, cancellationToken);
        ...
        if(__isset.lenValue)
        {
          tmp293.Name = "lenValue";
          tmp293.Type = TType.I64;
          tmp293.ID = 6;
          await oprot.WriteFieldBeginAsync(tmp293, cancellationToken);
    ...
    {
      var tmp294 = new StringBuilder("TGetInfoValue(");
      int tmp295 = 0;
      if((StringValue != null) && __isset.stringValue)
      {
        if(0 < tmp295++) { tmp294.Append(", "); }
        tmp294.Append("StringValue: ");
        StringValue.ToString(tmp294);
      }
      if(__isset.smallIntValue)
      {
        if(0 < tmp295++) { tmp294.Append(", "); }
        tmp294.Append("SmallIntValue: ");
        SmallIntValue.ToString(tmp294);
      }
      if(__isset.integerBitmask)
      {
        if(0 < tmp295++) { tmp294.Append(", "); }
        tmp294.Append("IntegerBitmask: ");
        IntegerBitmask.ToString(tmp294);
      }
      if(__isset.integerFlag)
      {
        if(0 < tmp295++) { tmp294.Append(", "); }
        tmp294.Append("IntegerFlag: ");
        IntegerFlag.ToString(tmp294);
      }
      if(__isset.binaryValue)
      {
        if(0 < tmp295++) { tmp294.Append(", "); }
        tmp294.Append("BinaryValue: ");
        BinaryValue.ToString(tmp294);
      }
      if(__isset.lenValue)
      {
        if(0 < tmp295++) { tmp294.Append(", "); }
        tmp294.Append("LenValue: ");
        LenValue.ToString(tmp294);
      }
      tmp294.Append(')');
