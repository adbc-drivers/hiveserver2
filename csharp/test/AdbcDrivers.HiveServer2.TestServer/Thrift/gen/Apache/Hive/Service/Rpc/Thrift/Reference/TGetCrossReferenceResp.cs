...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetCrossReferenceResp : TBase
  {
    ...
    public TGetCrossReferenceResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp435 = new TGetCrossReferenceResp();
      if((Status != null))
      {
        tmp435.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp435.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp435.__isset.operationHandle = this.__isset.operationHandle;
      return tmp435;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp436 = new TStruct("TGetCrossReferenceResp");
    ...
    {
      if (!(that is TGetCrossReferenceResp other)) return false;
    ...
    {
      var tmp438 = new StringBuilder("TGetCrossReferenceResp(");
      if((Status != null))
      {
