...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TSessionHandle : TBase
  {
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier SessionId { get; set; }

    public TSessionHandle()
    {
    }

    public TSessionHandle(global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier sessionId) : this()
    {
    ...
    public TSessionHandle DeepCopy()
    {
      ...
      if((SessionId != null))
      {
        tmp236.SessionId = (global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier)this.SessionId.DeepCopy();
      }
      return tmp236;
    }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                SessionId = new global::Apache.Hive.Service.Rpc.Thrift.Reference.THandleIdentifier();
