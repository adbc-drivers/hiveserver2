...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetPrimaryKeysReq : TBase
  {
    ...
    public TGetPrimaryKeysReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle) : this()
    {
    ...
    public TGetPrimaryKeysReq DeepCopy()
    {
      ...
      {
        tmp420.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
    ...
    {
      var tmp423 = new StringBuilder("TGetPrimaryKeysReq(");
      if((SessionHandle != null))
      {
      ...
      if((CatalogName != null) && __isset.catalogName)
      {
        tmp423.Append(", CatalogName: ");
        CatalogName.ToString(tmp423);
      }
      if((SchemaName != null) && __isset.schemaName)
      {
        tmp423.Append(", SchemaName: ");
        SchemaName.ToString(tmp423);
      }
      if((TableName != null) && __isset.tableName)
      {
        tmp423.Append(", TableName: ");
        TableName.ToString(tmp423);
      }
      tmp423.Append(')');
