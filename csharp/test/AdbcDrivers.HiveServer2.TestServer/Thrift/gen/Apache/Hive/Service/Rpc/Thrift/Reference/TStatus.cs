...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TStatus : TBase
  {
    ...
    public TStatus(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatusCode statusCode) : this()
    {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                StatusCode = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatusCode)await iprot.ReadI32Async(cancellationToken);
    ...
    {
      var tmp229 = new StringBuilder("TStatus(");
      tmp229.Append(", StatusCode: ");
      StatusCode.ToString(tmp229);
      if((InfoMessages != null) && __isset.infoMessages)
      {
        tmp229.Append(", InfoMessages: ");
        InfoMessages.ToString(tmp229);
      }
      if((SqlState != null) && __isset.sqlState)
      {
        tmp229.Append(", SqlState: ");
        SqlState.ToString(tmp229);
      }
      if(__isset.errorCode)
      {
        tmp229.Append(", ErrorCode: ");
        ErrorCode.ToString(tmp229);
      }
      if((ErrorMessage != null) && __isset.errorMessage)
      {
        tmp229.Append(", ErrorMessage: ");
        ErrorMessage.ToString(tmp229);
      }
      tmp229.Append(')');
