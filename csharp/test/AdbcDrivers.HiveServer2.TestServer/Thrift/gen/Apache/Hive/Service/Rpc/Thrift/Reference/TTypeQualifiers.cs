...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TTypeQualifiers : TBase
  {
    ...
    public Dictionary<string, global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifierValue> Qualifiers { get; set; }

    public TTypeQualifiers()
    {
    }

    public TTypeQualifiers(Dictionary<string, global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifierValue> @qualifiers) : this()
    {
              ...
              {
                {
                  ...
                  Qualifiers = new Dictionary<string, global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifierValue>(_map6.Count);
                  for(int _i7 = 0; _i7 < _map6.Count; ++_i7)
                  {
                    string _key8;
                    global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifierValue _val9;
                    _key8 = await iprot.ReadStringAsync(cancellationToken);
                    _val9 = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifierValue();
