...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TColumnDesc : TBase
  {
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeDesc TypeDesc { get; set; }
    ...
    public TColumnDesc(string columnName, global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeDesc typeDesc, int @position) : this()
    {
    ...
    public TColumnDesc DeepCopy()
    {
      ...
      if((TypeDesc != null))
      {
        tmp69.TypeDesc = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeDesc)this.TypeDesc.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                TypeDesc = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeDesc();
