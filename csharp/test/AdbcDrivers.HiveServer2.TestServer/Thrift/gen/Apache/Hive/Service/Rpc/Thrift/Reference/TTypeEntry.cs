...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TPrimitiveTypeEntry _primitiveEntry;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TArrayTypeEntry _arrayEntry;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TMapTypeEntry _mapEntry;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TStructTypeEntry _structEntry;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TUnionTypeEntry _unionEntry;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TUserDefinedTypeEntry _userDefinedTypeEntry;

    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TPrimitiveTypeEntry PrimitiveEntry
    {
      get
      {
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TArrayTypeEntry ArrayEntry
    {
      get
      {
        return _arrayEntry;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TMapTypeEntry MapEntry
    {
      get
      {
        return _mapEntry;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TStructTypeEntry StructEntry
    {
      get
      {
        return _structEntry;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TUnionTypeEntry UnionEntry
    {
      get
      {
        return _unionEntry;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TUserDefinedTypeEntry UserDefinedTypeEntry
    {
      get
      {
    ...
    public TTypeEntry DeepCopy()
    {
      ...
      {
        tmp55.PrimitiveEntry = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TPrimitiveTypeEntry)this.PrimitiveEntry.DeepCopy();
      }
      tmp55.__isset.primitiveEntry = this.__isset.primitiveEntry;
      if((ArrayEntry != null) && __isset.arrayEntry)
      {
        tmp55.ArrayEntry = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TArrayTypeEntry)this.ArrayEntry.DeepCopy();
      }
      tmp55.__isset.arrayEntry = this.__isset.arrayEntry;
      if((MapEntry != null) && __isset.mapEntry)
      {
        tmp55.MapEntry = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TMapTypeEntry)this.MapEntry.DeepCopy();
      }
      tmp55.__isset.mapEntry = this.__isset.mapEntry;
      if((StructEntry != null) && __isset.structEntry)
      {
        tmp55.StructEntry = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStructTypeEntry)this.StructEntry.DeepCopy();
      }
      tmp55.__isset.structEntry = this.__isset.structEntry;
      if((UnionEntry != null) && __isset.unionEntry)
      {
        tmp55.UnionEntry = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TUnionTypeEntry)this.UnionEntry.DeepCopy();
      }
      tmp55.__isset.unionEntry = this.__isset.unionEntry;
      if((UserDefinedTypeEntry != null) && __isset.userDefinedTypeEntry)
      {
        tmp55.UserDefinedTypeEntry = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TUserDefinedTypeEntry)this.UserDefinedTypeEntry.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                PrimitiveEntry = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TPrimitiveTypeEntry();
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                ArrayEntry = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TArrayTypeEntry();
            ...
            case 3:
              if (field.Type == TType.Struct)
              {
                MapEntry = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TMapTypeEntry();
            ...
            case 4:
              if (field.Type == TType.Struct)
              {
                StructEntry = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TStructTypeEntry();
            ...
            case 5:
              if (field.Type == TType.Struct)
              {
                UnionEntry = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TUnionTypeEntry();
            ...
            case 6:
              if (field.Type == TType.Struct)
              {
                UserDefinedTypeEntry = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TUserDefinedTypeEntry();
