...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetDelegationTokenResp : TBase
  {
    ...
    public TGetDelegationTokenResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TGetDelegationTokenResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp495.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
