...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle _operationHandle;

    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus Status { get; set; }

    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle OperationHandle
    {
      get
      {
    ...
    public TGetTableTypesResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp395 = new TGetTableTypesResp();
      if((Status != null))
      {
        tmp395.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp395.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp395.__isset.operationHandle = this.__isset.operationHandle;
      return tmp395;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp396 = new TStruct("TGetTableTypesResp");
    ...
    {
      if (!(that is TGetTableTypesResp other)) return false;
    ...
    {
      var tmp398 = new StringBuilder("TGetTableTypesResp(");
      if((Status != null))
      {
        tmp398.Append(", Status: ");
        Status.ToString(tmp398);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp398.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp398);
      }
      tmp398.Append(')');
