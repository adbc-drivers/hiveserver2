...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TUploadDataReq : TBase
  {
    ...
    public TUploadDataReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle, byte[] @values) : this()
    {
    ...
    public TUploadDataReq DeepCopy()
    {
      ...
      {
        tmp331.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
