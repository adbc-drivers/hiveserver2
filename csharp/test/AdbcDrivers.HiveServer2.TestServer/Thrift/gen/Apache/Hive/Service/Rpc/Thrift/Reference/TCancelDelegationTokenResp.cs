...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TCancelDelegationTokenResp : TBase
  {
    ...
    public TCancelDelegationTokenResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp505 = new TCancelDelegationTokenResp();
      if((Status != null))
      {
        tmp505.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      return tmp505;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp506 = new TStruct("TCancelDelegationTokenResp");
    ...
    {
      var tmp508 = new StringBuilder("TCancelDelegationTokenResp(");
      if((Status != null))
      {
