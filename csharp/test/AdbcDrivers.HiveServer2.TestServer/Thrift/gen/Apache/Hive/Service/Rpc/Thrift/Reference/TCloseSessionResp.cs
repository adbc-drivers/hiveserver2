...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TCloseSessionResp : TBase
  {
    ...
    public TCloseSessionResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TCloseSessionResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp286.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      return tmp286;
    }
    ...
    {
      var tmp289 = new StringBuilder("TCloseSessionResp(");
      if((Status != null))
      {
        tmp289.Append(", Status: ");
        Status.ToString(tmp289);
      }
      tmp289.Append(')');
