...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetTypeInfoResp : TBase
  {
    ...
    public TGetTypeInfoResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp326 = new TGetTypeInfoResp();
      if((Status != null))
      {
        tmp326.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp326.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp326.__isset.operationHandle = this.__isset.operationHandle;
      return tmp326;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp327 = new TStruct("TGetTypeInfoResp");
    ...
    {
      if (!(that is TGetTypeInfoResp other)) return false;
    ...
    {
      var tmp329 = new StringBuilder("TGetTypeInfoResp(");
      if((Status != null))
      {
        tmp329.Append(", Status: ");
        Status.ToString(tmp329);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp329.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp329);
      }
      tmp329.Append(')');
