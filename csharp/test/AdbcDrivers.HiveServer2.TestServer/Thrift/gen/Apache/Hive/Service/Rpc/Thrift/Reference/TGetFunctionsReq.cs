...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetFunctionsReq : TBase
  {
    ...
    public TGetFunctionsReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle, string functionName) : this()
    {
    ...
    public TGetFunctionsReq DeepCopy()
    {
      ...
      {
        tmp410.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
