...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TRenewDelegationTokenResp : TBase
  {
    ...
    public TRenewDelegationTokenResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp515 = new TRenewDelegationTokenResp();
      if((Status != null))
      {
        tmp515.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      return tmp515;
    }
    ...
    {
      var tmp518 = new StringBuilder("TRenewDelegationTokenResp(");
      if((Status != null))
      {
        tmp518.Append(", Status: ");
        Status.ToString(tmp518);
      }
      tmp518.Append(')');
