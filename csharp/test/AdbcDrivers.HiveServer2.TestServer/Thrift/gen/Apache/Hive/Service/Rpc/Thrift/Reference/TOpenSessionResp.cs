...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle _sessionHandle;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle SessionHandle
    {
      get
      {
    ...
    {
      this.ServerProtocolVersion = global::Apache.Hive.Service.Rpc.Thrift.Reference.TProtocolVersion.HIVE_CLI_SERVICE_PROTOCOL_V10;
    }

    public TOpenSessionResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status, global::Apache.Hive.Service.Rpc.Thrift.Reference.TProtocolVersion serverProtocolVersion) : this()
    {
      this.Status = @status;
    ...
    public TOpenSessionResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp256.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      tmp256.ServerProtocolVersion = this.ServerProtocolVersion;
      if((SessionHandle != null) && __isset.sessionHandle)
      {
        tmp256.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                ServerProtocolVersion = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TProtocolVersion)await iprot.ReadI32Async(cancellationToken);
            ...
            case 3:
              if (field.Type == TType.Struct)
              {
                SessionHandle = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle();
