...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TOpenSessionReq : TBase
  {
    ...
    {
      this.Client_protocol = global::Apache.Hive.Service.Rpc.Thrift.Reference.TProtocolVersion.HIVE_CLI_SERVICE_PROTOCOL_V10;
    }

    public TOpenSessionReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TProtocolVersion client_protocol) : this()
    {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                Client_protocol = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TProtocolVersion)await iprot.ReadI32Async(cancellationToken);
    ...
    {
      var tmp254 = new StringBuilder("TOpenSessionReq(");
      tmp254.Append(", Client_protocol: ");
      Client_protocol.ToString(tmp254);
      if((Username != null) && __isset.@username)
      {
        tmp254.Append(", Username: ");
        Username.ToString(tmp254);
      }
      if((Password != null) && __isset.@password)
      {
        tmp254.Append(", Password: ");
        Password.ToString(tmp254);
      }
      if((Configuration != null) && __isset.@configuration)
      {
        tmp254.Append(", Configuration: ");
        Configuration.ToString(tmp254);
      }
      tmp254.Append(')');
