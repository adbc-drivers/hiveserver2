...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TProgressUpdateResp : TBase
  {
    ...
    /// <summary>
    /// 
    /// <seealso cref="global::Apache.Hive.Service.Rpc.Thrift.Reference.TJobExecutionStatus"/>
    /// </summary>
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TJobExecutionStatus Status { get; set; }
    ...
    public TProgressUpdateResp(List<string> headerNames, List<List<string>> @rows, double progressedPercentage, global::Apache.Hive.Service.Rpc.Thrift.Reference.TJobExecutionStatus @status, string footerSummary, long startTime) : this()
    {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 4:
              ...
              {
                Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TJobExecutionStatus)await iprot.ReadI32Async(cancellationToken);
                isset_status = true;
              }
              else
              {
    ...
    {
      var tmp535 = new StringBuilder("TProgressUpdateResp(");
      if((HeaderNames != null))
      {
        tmp535.Append(", HeaderNames: ");
        HeaderNames.ToString(tmp535);
      }
      if((Rows != null))
      {
        tmp535.Append(", Rows: ");
        Rows.ToString(tmp535);
      }
      tmp535.Append(", ProgressedPercentage: ");
      ProgressedPercentage.ToString(tmp535);
      tmp535.Append(", Status: ");
      Status.ToString(tmp535);
      if((FooterSummary != null))
      {
        tmp535.Append(", FooterSummary: ");
        FooterSummary.ToString(tmp535);
      }
      tmp535.Append(", StartTime: ");
      StartTime.ToString(tmp535);
      tmp535.Append(')');
