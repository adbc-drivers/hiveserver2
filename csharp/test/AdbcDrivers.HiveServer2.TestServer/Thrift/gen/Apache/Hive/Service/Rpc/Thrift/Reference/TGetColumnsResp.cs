...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetColumnsResp : TBase
  {
    ...
    public TGetColumnsResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp405 = new TGetColumnsResp();
      if((Status != null))
      {
        tmp405.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp405.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp405.__isset.operationHandle = this.__isset.operationHandle;
      return tmp405;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp406 = new TStruct("TGetColumnsResp");
    ...
    {
      var tmp408 = new StringBuilder("TGetColumnsResp(");
      if((Status != null))
      {
        tmp408.Append(", Status: ");
        Status.ToString(tmp408);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp408.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp408);
      }
      tmp408.Append(')');
