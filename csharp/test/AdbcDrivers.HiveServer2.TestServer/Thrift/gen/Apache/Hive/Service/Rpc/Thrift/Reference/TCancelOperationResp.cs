...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TCancelOperationResp : TBase
  {
    ...
    public TCancelOperationResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp455 = new TCancelOperationResp();
      if((Status != null))
      {
        tmp455.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      return tmp455;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp456 = new TStruct("TCancelOperationResp");
    ...
    {
      var tmp458 = new StringBuilder("TCancelOperationResp(");
      if((Status != null))
      {
        tmp458.Append(", Status: ");
        Status.ToString(tmp458);
      }
      tmp458.Append(')');
