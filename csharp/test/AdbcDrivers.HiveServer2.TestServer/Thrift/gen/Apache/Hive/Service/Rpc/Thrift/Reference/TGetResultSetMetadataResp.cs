...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TTableSchema _schema;

    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus Status { get; set; }

    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TTableSchema Schema
    {
      get
      {
        return _schema;
    ...
    public TGetResultSetMetadataResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TGetResultSetMetadataResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp475.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((Schema != null) && __isset.@schema)
      {
        tmp475.Schema = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TTableSchema)this.Schema.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                Schema = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TTableSchema();
