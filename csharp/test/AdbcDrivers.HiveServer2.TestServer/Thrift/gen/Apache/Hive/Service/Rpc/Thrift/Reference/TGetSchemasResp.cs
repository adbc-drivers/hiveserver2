...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetSchemasResp : TBase
  {
    ...
    public TGetSchemasResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp371 = new TGetSchemasResp();
      if((Status != null))
      {
        tmp371.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp371.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp371.__isset.operationHandle = this.__isset.operationHandle;
      return tmp371;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp372 = new TStruct("TGetSchemasResp");
    ...
    {
      var tmp374 = new StringBuilder("TGetSchemasResp(");
      if((Status != null))
      {
        tmp374.Append(", Status: ");
        Status.ToString(tmp374);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp374.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp374);
      }
      tmp374.Append(')');
