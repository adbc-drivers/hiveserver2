...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetTypeInfoReq : TBase
  {
    ...
    public TGetTypeInfoReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle) : this()
    {
    ...
    {
      var tmp321 = new TGetTypeInfoReq();
      if((SessionHandle != null))
      {
        tmp321.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
      return tmp321;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp322 = new TStruct("TGetTypeInfoReq");
    ...
    {
      var tmp324 = new StringBuilder("TGetTypeInfoReq(");
      if((SessionHandle != null))
      {
        tmp324.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp324);
      }
      tmp324.Append(')');
