...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TExecuteStatementResp : TBase
  {
    ...
    public TExecuteStatementResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TExecuteStatementResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp316.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp316.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
    ...
    {
      var tmp319 = new StringBuilder("TExecuteStatementResp(");
      if((Status != null))
      {
        tmp319.Append(", Status: ");
        Status.ToString(tmp319);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp319.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp319);
      }
      tmp319.Append(')');
