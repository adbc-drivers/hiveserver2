...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  {
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TBoolColumn _boolVal;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TByteColumn _byteVal;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TI16Column _i16Val;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TI32Column _i32Val;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TI64Column _i64Val;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TDoubleColumn _doubleVal;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TStringColumn _stringVal;
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TBinaryColumn _binaryVal;

    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TBoolColumn BoolVal
    {
      get
      {
        return _boolVal;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TByteColumn ByteVal
    {
      get
      {
        return _byteVal;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TI16Column I16Val
    {
      get
      {
        return _i16Val;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TI32Column I32Val
    {
      get
      {
        return _i32Val;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TI64Column I64Val
    {
      get
      {
        return _i64Val;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TDoubleColumn DoubleVal
    {
      get
      {
        return _doubleVal;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TStringColumn StringVal
    {
      get
      {
        return _stringVal;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TBinaryColumn BinaryVal
    {
      get
      {
        return _binaryVal;
    ...
    public TColumn DeepCopy()
    {
      ...
      {
        tmp204.BoolVal = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TBoolColumn)this.BoolVal.DeepCopy();
      }
      tmp204.__isset.boolVal = this.__isset.boolVal;
      if((ByteVal != null) && __isset.byteVal)
      {
        tmp204.ByteVal = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TByteColumn)this.ByteVal.DeepCopy();
      }
      tmp204.__isset.byteVal = this.__isset.byteVal;
      if((I16Val != null) && __isset.i16Val)
      {
        tmp204.I16Val = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TI16Column)this.I16Val.DeepCopy();
      }
      tmp204.__isset.i16Val = this.__isset.i16Val;
      if((I32Val != null) && __isset.i32Val)
      {
        tmp204.I32Val = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TI32Column)this.I32Val.DeepCopy();
      }
      tmp204.__isset.i32Val = this.__isset.i32Val;
      if((I64Val != null) && __isset.i64Val)
      {
        tmp204.I64Val = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TI64Column)this.I64Val.DeepCopy();
      }
      tmp204.__isset.i64Val = this.__isset.i64Val;
      if((DoubleVal != null) && __isset.doubleVal)
      {
        tmp204.DoubleVal = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TDoubleColumn)this.DoubleVal.DeepCopy();
      }
      tmp204.__isset.doubleVal = this.__isset.doubleVal;
      if((StringVal != null) && __isset.stringVal)
      {
        tmp204.StringVal = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStringColumn)this.StringVal.DeepCopy();
      }
      tmp204.__isset.stringVal = this.__isset.stringVal;
      if((BinaryVal != null) && __isset.binaryVal)
      {
        tmp204.BinaryVal = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TBinaryColumn)this.BinaryVal.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                BoolVal = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TBoolColumn();
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                ByteVal = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TByteColumn();
            ...
            case 3:
              if (field.Type == TType.Struct)
              {
                I16Val = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TI16Column();
            ...
            case 4:
              if (field.Type == TType.Struct)
              {
                I32Val = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TI32Column();
            ...
            case 5:
              if (field.Type == TType.Struct)
              {
                I64Val = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TI64Column();
            ...
            case 6:
              if (field.Type == TType.Struct)
              {
                DoubleVal = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TDoubleColumn();
            ...
            case 7:
              if (field.Type == TType.Struct)
              {
                StringVal = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TStringColumn();
            ...
            case 8:
              if (field.Type == TType.Struct)
              {
                BinaryVal = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TBinaryColumn();
