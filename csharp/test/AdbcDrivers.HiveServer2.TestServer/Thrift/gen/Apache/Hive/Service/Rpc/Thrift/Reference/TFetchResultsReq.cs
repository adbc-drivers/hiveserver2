...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TFetchResultsReq : TBase
  {
    ...
    {
      this.Orientation = global::Apache.Hive.Service.Rpc.Thrift.Reference.TFetchOrientation.FETCH_NEXT;
      this._fetchType = 0;
      this.__isset.fetchType = true;
    }

    public TFetchResultsReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle operationHandle, global::Apache.Hive.Service.Rpc.Thrift.Reference.TFetchOrientation @orientation, long maxRows) : this()
    {
    ...
    public TFetchResultsReq DeepCopy()
    {
      ...
      {
        tmp480.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                Orientation = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TFetchOrientation)await iprot.ReadI32Async(cancellationToken);
