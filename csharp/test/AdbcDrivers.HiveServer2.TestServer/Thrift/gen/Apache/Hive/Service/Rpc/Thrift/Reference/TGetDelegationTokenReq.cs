...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetDelegationTokenReq : TBase
  {
    ...
    public TGetDelegationTokenReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle, string @owner, string @renewer) : this()
    {
    ...
    public TGetDelegationTokenReq DeepCopy()
    {
      ...
      {
        tmp490.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
      if((Owner != null))
      {
