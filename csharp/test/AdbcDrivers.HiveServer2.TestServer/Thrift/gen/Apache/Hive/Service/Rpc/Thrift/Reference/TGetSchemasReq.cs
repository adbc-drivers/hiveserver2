...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetSchemasReq : TBase
  {
    ...
    public TGetSchemasReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle) : this()
    {
    ...
    public TGetSchemasReq DeepCopy()
    {
      ...
      {
        tmp366.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
    ...
    {
      var tmp369 = new StringBuilder("TGetSchemasReq(");
      if((SessionHandle != null))
      {
        tmp369.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp369);
      }
      if((CatalogName != null) && __isset.catalogName)
      {
        tmp369.Append(", CatalogName: ");
        CatalogName.ToString(tmp369);
      }
      if((SchemaName != null) && __isset.schemaName)
      {
        tmp369.Append(", SchemaName: ");
        SchemaName.ToString(tmp369);
      }
      tmp369.Append(')');
