...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TCloseOperationResp : TBase
  {
    ...
    public TCloseOperationResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp465 = new TCloseOperationResp();
      if((Status != null))
      {
        tmp465.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      return tmp465;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp466 = new TStruct("TCloseOperationResp");
    ...
    {
      if (!(that is TCloseOperationResp other)) return false;
    ...
    {
      var tmp468 = new StringBuilder("TCloseOperationResp(");
      if((Status != null))
      {
        tmp468.Append(", Status: ");
        Status.ToString(tmp468);
      }
      tmp468.Append(')');
