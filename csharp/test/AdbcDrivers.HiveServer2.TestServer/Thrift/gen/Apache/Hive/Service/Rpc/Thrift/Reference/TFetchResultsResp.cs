...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TFetchResultsResp : TBase
  {
    ...
    private global::Apache.Hive.Service.Rpc.Thrift.Reference.TRowSet _results;
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TRowSet Results
    {
      get
      {
        return _results;
    ...
    public TFetchResultsResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public TFetchResultsResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp485.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      ...
      {
        tmp485.Results = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TRowSet)this.Results.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.Struct)
              {
                Results = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TRowSet();
