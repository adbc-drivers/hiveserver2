...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class THandleIdentifier : TBase
  {
    ...
    {
      var tmp231 = new THandleIdentifier();
      if((Guid != null))
      {
        tmp231.Guid = this.Guid.ToArray();
      }
      if((Secret != null))
      {
        tmp231.Secret = this.Secret.ToArray();
      }
      return tmp231;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp232 = new TStruct("THandleIdentifier");
    ...
    {
      var tmp234 = new StringBuilder("THandleIdentifier(");
      if((Guid != null))
      {
        tmp234.Append(", Guid: ");
        Guid.ToString(tmp234);
      }
      if((Secret != null))
      {
        tmp234.Append(", Secret: ");
        Secret.ToString(tmp234);
      }
      tmp234.Append(')');
