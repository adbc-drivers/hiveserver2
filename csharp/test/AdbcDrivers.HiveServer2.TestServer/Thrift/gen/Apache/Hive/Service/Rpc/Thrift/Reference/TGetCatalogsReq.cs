...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetCatalogsReq : TBase
  {
    ...
    public TGetCatalogsReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle) : this()
    {
    ...
    {
      var tmp356 = new TGetCatalogsReq();
      if((SessionHandle != null))
      {
        tmp356.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
      return tmp356;
    }
    ...
    {
      var tmp359 = new StringBuilder("TGetCatalogsReq(");
      if((SessionHandle != null))
      {
        tmp359.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp359);
      }
      tmp359.Append(')');
