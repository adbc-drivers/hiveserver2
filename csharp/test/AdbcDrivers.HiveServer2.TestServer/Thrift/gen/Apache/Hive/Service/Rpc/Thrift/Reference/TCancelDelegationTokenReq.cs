...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TCancelDelegationTokenReq : TBase
  {
    ...
    public TCancelDelegationTokenReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle, string delegationToken) : this()
    {
    ...
    {
      var tmp500 = new TCancelDelegationTokenReq();
      if((SessionHandle != null))
      {
        tmp500.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
      if((DelegationToken != null))
      {
        tmp500.DelegationToken = this.DelegationToken;
      }
      return tmp500;
    }
    ...
    {
      var tmp503 = new StringBuilder("TCancelDelegationTokenReq(");
      if((SessionHandle != null))
      {
        tmp503.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp503);
      }
      if((DelegationToken != null))
      {
        tmp503.Append(", DelegationToken: ");
        DelegationToken.ToString(tmp503);
      }
      tmp503.Append(')');
