...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetTablesReq : TBase
  {
    ...
    public TGetTablesReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle) : this()
    {
    ...
    public TGetTablesReq DeepCopy()
    {
      ...
      {
        tmp376.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
    ...
    {
      var tmp383 = new StringBuilder("TGetTablesReq(");
      if((SessionHandle != null))
      {
        tmp383.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp383);
      }
      if((CatalogName != null) && __isset.catalogName)
      {
        tmp383.Append(", CatalogName: ");
        CatalogName.ToString(tmp383);
      }
      if((SchemaName != null) && __isset.schemaName)
      {
        tmp383.Append(", SchemaName: ");
        SchemaName.ToString(tmp383);
      }
      if((TableName != null) && __isset.tableName)
      {
        tmp383.Append(", TableName: ");
        TableName.ToString(tmp383);
      }
      if((TableTypes != null) && __isset.tableTypes)
      {
        tmp383.Append(", TableTypes: ");
        TableTypes.ToString(tmp383);
      }
      tmp383.Append(')');
