...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TI64Column : TBase
  {
    ...
    {
      var tmp168 = new TI64Column();
      if((Values != null))
      {
        tmp168.Values = this.Values.DeepCopy();
      }
      if((Nulls != null))
      {
        tmp168.Nulls = this.Nulls.ToArray();
      }
      return tmp168;
    }
              ...
              {
                {
                  ...
                  Values = new List<long>(_list169.Count);
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((Values != null))
        {
          ...
          foreach (long _iter174 in Values)
          {
