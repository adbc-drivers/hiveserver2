...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TRenewDelegationTokenReq : TBase
  {
    ...
    public TRenewDelegationTokenReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle, string delegationToken) : this()
    {
    ...
    {
      var tmp510 = new TRenewDelegationTokenReq();
      if((SessionHandle != null))
      {
        tmp510.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
      if((DelegationToken != null))
      {
        tmp510.DelegationToken = this.DelegationToken;
      }
      return tmp510;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((DelegationToken != null))
        {
          tmp512.Name = "delegationToken";
          tmp512.Type = TType.String;
          tmp512.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp512, cancellationToken);
    ...
    {
      var tmp513 = new StringBuilder("TRenewDelegationTokenReq(");
      if((SessionHandle != null))
      {
        tmp513.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp513);
      }
      if((DelegationToken != null))
      {
        tmp513.Append(", DelegationToken: ");
        DelegationToken.ToString(tmp513);
      }
      tmp513.Append(')');
