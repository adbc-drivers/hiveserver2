...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TUploadDataResp : TBase
  {
    ...
    public TUploadDataResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status, global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle operationHandle) : this()
    {
      this.Status = @status;
    ...
    public TUploadDataResp DeepCopy()
    {
      ...
      if((Status != null))
      {
        tmp336.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null))
      {
        tmp336.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      return tmp336;
    }
