...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetPrimaryKeysResp : TBase
  {
    ...
    public TGetPrimaryKeysResp(global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    {
      var tmp425 = new TGetPrimaryKeysResp();
      if((Status != null))
      {
        tmp425.Status = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TStatus)this.Status.DeepCopy();
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp425.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp425.__isset.operationHandle = this.__isset.operationHandle;
      return tmp425;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp426 = new TStruct("TGetPrimaryKeysResp");
    ...
    {
      var tmp428 = new StringBuilder("TGetPrimaryKeysResp(");
      if((Status != null))
      {
        tmp428.Append(", Status: ");
        Status.ToString(tmp428);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp428.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp428);
      }
      tmp428.Append(')');
