...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TGetOperationStatusReq : TBase
  {
    ...
    public TGetOperationStatusReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle operationHandle) : this()
    {
    ...
    public TGetOperationStatusReq DeepCopy()
    {
      ...
      {
        tmp440.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TOperationHandle)this.OperationHandle.DeepCopy();
      }
    ...
    {
      var tmp443 = new StringBuilder("TGetOperationStatusReq(");
      if((OperationHandle != null))
      {
      ...
      if(__isset.getProgressUpdate)
      {
        tmp443.Append(", GetProgressUpdate: ");
        GetProgressUpdate.ToString(tmp443);
      }
      tmp443.Append(')');
