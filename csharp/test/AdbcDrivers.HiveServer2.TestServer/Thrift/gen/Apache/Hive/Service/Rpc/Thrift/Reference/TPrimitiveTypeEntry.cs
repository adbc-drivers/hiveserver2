...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TPrimitiveTypeEntry : TBase
  {
    ...
    public global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifiers TypeQualifiers
    {
      get
      {
    ...
    public TPrimitiveTypeEntry(global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeId @type) : this()
    {
      this.Type = @type;
    }
    ...
    public TPrimitiveTypeEntry DeepCopy()
    {
      ...
      {
        tmp15.TypeQualifiers = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifiers)this.TypeQualifiers.DeepCopy();
      }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                Type = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeId)await iprot.ReadI32Async(cancellationToken);
                isset_type = true;
              }
              else
              {
            ...
            case 2:
              ...
              {
                TypeQualifiers = new global::Apache.Hive.Service.Rpc.Thrift.Reference.TTypeQualifiers();
