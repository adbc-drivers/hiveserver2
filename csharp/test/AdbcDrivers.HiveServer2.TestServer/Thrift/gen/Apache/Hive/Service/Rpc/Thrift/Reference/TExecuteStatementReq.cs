...
namespace Apache.Hive.Service.Rpc.Thrift.Reference
{
  ...
  public partial class TExecuteStatementReq : TBase
  {
    ...
    public TExecuteStatementReq(global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle sessionHandle, string @statement) : this()
    {
    ...
    public TExecuteStatementReq DeepCopy()
    {
      ...
      {
        tmp306.SessionHandle = (global::Apache.Hive.Service.Rpc.Thrift.Reference.TSessionHandle)this.SessionHandle.DeepCopy();
      }
      if((Statement != null))
      {
